...
import com.softline.helpdesk.domain.dtos.TecnicoDTO;
import com.softline.helpdesk.repositories.PessoaRepository;
import com.softline.helpdesk.repositories.TecnicoRepository;
import com.softline.helpdesk.services.exceptions.DataIntegrityViolationException;
...
public class TecnicoService {
	...
	public Tecnico update(Integer id, @Valid TecnicoDTO objDTO) {
		...
		if(!objDTO.getSenha().equals(oldObj.getSenha())) { //verifica se a senha foi alterada, caso seja encoda novamente
			objDTO.setSenha(encoder.encode(objDTO.getSenha()));
		}
